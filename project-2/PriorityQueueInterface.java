/**
 * Provides priority queue management via enqueue, dequeue, isEmpty and update
 * methods.
 * You are expected to implement this interface in your MyPriorityQueue class,
 * which should
 * extend the MaxHeap class. In this case, the priority queue is the abstract
 * data type while the
...
public interface PriorityQueueInterface {
    ...
    /**
     * Increase the priorities for a given process in the queue if it has waited
     * enough
     * time but not to exceed its maximum priority.
     *
     * @param timeToIncrementPriority how long it should have waited for
     * @param maxPriority             the maximum priority value the process can
     *                                have
     */
